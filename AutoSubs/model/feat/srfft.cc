...
template<typename Real> static void ComplexMul(const Real &a_re, const Real &a_im,
                                            Real *b_re, Real *b_im) {
...
template<typename Real> static void ComplexAddProduct(const Real &a_re, const Real &a_im,
